...
export default function Footer() {
    ...
    return (
        <footer className={s.footer}>
            ...
            <a href={REPO_URL} target="_blank"><GithubIcon size="24" /></a>
        </footer>
    );
}
...
function GithubIcon({ size }) {
    return (
        <svg className={s.repo} width={size} height={size} viewBox="0 0 98 96" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
